...
```
room://cloud.tencent.com/rtc?sdkappid=1400xxxxxx&roomid=10001&userid=user123&usersig=xxx&appscene=videocall&encsmall=0&cloudenv=PRO&enableBlackStream=0&streamid=&userdefinerecordid=&privatemapkey=&pureaudiomode=1&recvmode=1
```
...
```
room://cloud.tencent.com/rtc?sdkappid=1400xxxxxx&roomid=10001&userid=remoteUser&usersig=xxx&appscene=videocall&streamtype=main
```
