...
window.I18N_DATA = {
  'zh-CN':{
    ...
    modes:{coach:{label:'教练模式',desc:'每句说完自动弹出一张可关闭的纠正卡片（纯文字、不打断对话），想被认真纠错就选它。'},buddy:{label:'陪伴模式',desc:'对话最流畅，纠正只显示在气泡旁的小卡片、不弹层。'}},
    paces:{auto:{label:'自动应答',desc:'说完停顿一下，AI 就自动接话（接近真实对话）。适合进阶学习者。'},manual:{label:'想好再说',desc:'AI 不会自动插话，你可以慢慢组织语言；点"说完了"再让 AI 回应。适合新手。'}},
  ...
  'zh-TW':{
    ...
    modes:{coach:{label:'教練模式',desc:'每句說完自動彈出一張可關閉的糾正卡片（純文字、不打斷對話），想被認真糾錯就選它。'},buddy:{label:'陪伴模式',desc:'對話最流暢，糾正只顯示在氣泡旁的小卡片、不彈層。'}},
    paces:{auto:{label:'自動應答',desc:'說完停頓一下，AI 就自動接話（接近真實對話）。適合進階學習者。'},manual:{label:'想好再說',desc:'AI 不會自動插話，你可以慢慢組織語言；點「說完了」再讓 AI 回應。適合新手。'}},
  ...
  'en':{
    ...
    modes:{coach:{label:'Coach',desc:'After each sentence, a dismissible correction card pops up (text only, no interruption). Best for serious practice.'},buddy:{label:'Buddy',desc:'Smoothest conversation — corrections show only as a small card next to the bubble, no popup.'}},
    paces:{auto:{label:'Auto reply',desc:'Pause after you finish and the AI replies on its own (close to a real conversation). Best for advanced learners.'},manual:{label:'Think first',desc:"The AI won't jump in — take your time to form sentences, then tap \u201cI'm done\u201d for the AI to reply. Best for beginners."}},
  ...
  'ja':{
    ...
    modes:{coach:{label:'コーチ',desc:'一文ごとに、閉じられる訂正カードが自動で表示されます（テキストのみ・会話を止めません）。しっかり直したい人向け。'},buddy:{label:'バディ',desc:'会話が最もスムーズ。訂正は吹き出し横の小さなカードに表示するだけで、ポップアップなし。'}},
    paces:{auto:{label:'自動応答',desc:'話し終えて少し間を置くと、AI が自動で返答します（本物の会話に近い）。上級者向け。'},manual:{label:'考えてから',desc:'AI は割り込みません。ゆっくり文を組み立て、「話し終えた」を押すと AI が返答します。初心者向け。'}},
  ...
  'ko':{
    ...
    modes:{coach:{label:'코치',desc:'문장을 말할 때마다 닫을 수 있는 교정 카드가 자동으로 표시됩니다(텍스트만, 대화를 끊지 않음). 제대로 교정받고 싶을 때 선택하세요.'},buddy:{label:'버디',desc:'가장 자연스러운 대화. 교정은 말풍선 옆 작은 카드로만 표시되고 팝업 없음.'}},
    paces:{auto:{label:'자동 응답',desc:'말을 마치고 잠시 멈추면 AI가 알아서 대답합니다(실제 대화에 가까움). 상급자용.'},manual:{label:'생각한 뒤 말하기',desc:'AI가 끼어들지 않아요. 천천히 문장을 만든 뒤 "다 말했어요"를 누르면 AI가 대답합니다. 초보자용.'}},
...
window.I18N = {
  'zh-CN':{
    ...
    'pref.style':'交流风格','pref.pace':'语速','pref.voice':'音色','pref.lang':'界面语言','pref.mode':'对话模式',
    'pref.pace2':'应答节奏','pref.paceHint':'新手建议选「想好再说」，可以慢慢组织语言；进阶可选「自动应答」，更接近真实对话。',
    'btn.startChat':'开始对话',
    'practice.start':'开始对话','practice.stop':'结束说话','practice.micOn':'收音中','practice.micMuted':'点击说话',
    'practice.tapToTalk':'点击说话','practice.imDone':'说完了',
    'practice.fcTitle':'口语纠正卡','practice.fcBetter':'更地道的说法',
  ...
  'zh-TW':{
    ...
    'pref.style':'交流風格','pref.pace':'語速','pref.voice':'音色','pref.lang':'介面語言','pref.mode':'對話模式',
    'pref.pace2':'應答節奏','pref.paceHint':'新手建議選「想好再說」，可以慢慢組織語言；進階可選「自動應答」，更接近真實對話。',
    'btn.startChat':'開始對話',
    'practice.start':'開始對話','practice.stop':'結束說話','practice.micOn':'收音中','practice.micMuted':'點擊說話',
    'practice.tapToTalk':'點擊說話','practice.imDone':'說完了',
    'practice.fcTitle':'口語糾正卡','practice.fcBetter':'更道地的說法',
    'theme.toggle':'切換深色/淺色模式',
  ...
  'en':{
    ...
    'pref.style':'Style','pref.pace':'Pace','pref.voice':'Voice','pref.lang':'Language','pref.mode':'Mode',
    'pref.pace2':'Reply pace','pref.paceHint':'New to English? Pick “Think first” to take your time forming sentences. More advanced? “Auto reply” feels closer to a real conversation.',
    'btn.startChat':'Start chatting',
    'practice.start':'Start talking','practice.stop':'Stop talking','practice.micOn':'Listening','practice.micMuted':'Tap to speak',
    'practice.tapToTalk':'Tap to talk','practice.imDone':"I'm done",
    'practice.fcTitle':'Correction card','practice.fcBetter':'More natural',
  ...
  'ja':{
    ...
    'pref.style':'スタイル','pref.pace':'話す速さ','pref.voice':'声色','pref.lang':'表示言語','pref.mode':'会話モード',
    'pref.pace2':'応答ペース','pref.paceHint':'初心者は「考えてから」がおすすめ。ゆっくり文を組み立てられます。上級者は「自動応答」で本物の会話に近づきます。',
    'btn.startChat':'会話を始める',
    'practice.start':'話し始める','practice.stop':'話し終える','practice.micOn':'集音中','practice.micMuted':'タップして話す',
    'practice.tapToTalk':'タップして話す','practice.imDone':'話し終えた',
    'practice.fcTitle':'添削カード','practice.fcBetter':'より自然な言い方',
  ...
  'ko':{
    ...
    'pref.style':'스타일','pref.pace':'속도','pref.voice':'음색','pref.lang':'인터페이스 언어','pref.mode':'대화 모드',
    'pref.pace2':'응답 속도','pref.paceHint':'초보자는 "생각한 뒤 말하기"를 추천해요. 천천히 문장을 만들 수 있어요. 상급자는 "자동 응답"으로 실제 대화에 가깝게.',
    'btn.startChat':'대화 시작',
    'practice.start':'대화 시작','practice.stop':'말하기 종료','practice.micOn':'수음 중','practice.micMuted':'탭하여 말하기',
    'practice.tapToTalk':'탭하여 말하기','practice.imDone':'다 말했어요',
    'practice.fcTitle':'교정 카드','practice.fcBetter':'더 자연스러운 표현',
...
window.applyDataI18n = function(){
  ...
  if(Array.isArray(D.modes)) D.modes.forEach(s=>{ const x=(L.modes||{})[s.id]; if(x){ s.label=x.label; s.desc=x.desc; }});
  if(Array.isArray(D.paces)) D.paces.forEach(s=>{ const x=(L.paces||{})[s.id]; if(x){ s.label=x.label; s.desc=x.desc; }});
